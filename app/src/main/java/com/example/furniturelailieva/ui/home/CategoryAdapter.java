...
import com.example.furniturelailieva.databinding.ItemCategoryBinding;
        ...
        public void onBind(CategoryModel categoryModel) {
            ...
            itemView.setOnClickListener(v-> {
                ...
                switch (categoryModel.getTitle()) {
                    ...
                    case "Мебель для детских":
                        navController = Navigation.findNavController((Activity) itemView.getContext(),
                                R.id.nav_host_fragment_activity_main);
                        navController.navigate(R.id.action_navigation_home_to_childrenFragment);
